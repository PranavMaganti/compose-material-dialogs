...
**Current Compose Version: 1.0.0-beta02**
...
dependencies {
  ...
  implementation "com.vanpra.compose-material-dialogs:core:0.3.1" 
  ...
}
```
...
dependencies {
  ...
  implementation "com.vanpra.compose-material-dialogs:color:0.3.1"
  ...
}
```
